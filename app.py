...
GOOGLE_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzQZzHFCOJPBZvUDcjn1J4ETNWsDpHiF1ziIBTs_0fnxFXjkLcVOJtjCo7UNqE22VW2Tw/exec"
# ==========================================
...
items_data = [
    ...
    (
        "9",
        "محور 'رقيم' والسياسات العامة",
        "وجود قائمة محدثة بالمخزون وقائمة المصرح لهم بدخول الصيدلية (خلال"
        " الدوام وخارجه).",
    ),
    (
        "10",
    ...
    (
        "18",
        "محور غرفة الأدوية والصيدلية وغرفة الطوارئ",
        "ترتيب الأدوية حسب الشكل الصيدلاني وتاريخ الصلاحية مع وضع التصنيف"
        " اللوني (Code Coloring).",
    ),
    (
        "19",
        "محور غرفة الأدوية والصيدلية وغرفة الطوارئ",
    ...
    (
        "25",
        "الثلاجة الطبية",
        "مطابقة الثلاجة للمعايير وضبط درجات الحرارة الخاصة بحفظ الأدوية"
        " المبردة (2 إلى 8 درجات)على مدار 24 ساعة.",
    ),
    (
        "26",
        "الثلاجة الطبية",
        "وجود جهاز رقمي معتمد ومثبت لقياس درجات الحرارة والرطوبة داخل"
        " الثلاجة.",
    ),
    (
        "27",
    ...
    (
        "29",
        "الثلاجة الطبية",
        "الإلتزام بوضع لواصق عالية الخطورة و LASA على الأدوية المبردة الخاصة"
        " بها.",
    ),
    ...
    (
        ...
        "توفر مؤشر واستمارت اكتمال أدوية الطوارئ وجاهزيتها بنسبة 100% بداخل"
        " المركز.",
    ),
    (
        "32",
    ...
    (
        "33",
        "محور عربة الطوارئ والحقيبة الإسعافية",
        "وجود جهاز قياس درجة الحرارة والرطوبة مخصص لغرفة الطوارئ لضمان"
        " سلامة الأدوية.",
    ),
    (
        "34",
    ...
    (
        "37",
        "محور عربة الطوارئ والحقيبة الإسعافية",
        "الإلتزام بتوفير الكميات المطلوبة وعدم وجود أدوية زائدة أو منتهية"
        " الصلاحية.",
    ),
    (
        "38",
...
st.markdown("---")
st.caption(
    "إدارة الخدمات الصيدلانية لمراكز الرعاية الصحية الأولية - تجمع الرياض"
    " الصحي الثاني"
)
